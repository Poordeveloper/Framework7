 ...
 * 
 * 
 * Included modules: searchbar,messages,modals,smart-select,virtual-list,infinite-scroll,scroll-toolbars,tabs,fast-clicks,push-state,swipeout,swiper
 * 
    ...
    window.Framework7 = function (params) {
        ...
        ************   Swipeout Actions (Swipe to delete)   ************
        ...
        window.Swiper = function (container, params) {
            ...
            s.getWrapperTranslate = function () {
                return s.getTranslate(s.wrapper[0]);
            };
